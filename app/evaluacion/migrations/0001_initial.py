# Generated by Django 4.1.3 on 2023-01-20 00:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula', models.CharField(max_length=10, unique=True)),
                ('asignatura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='evaluacion.asignatura', verbose_name='Asignatura del docente')),
