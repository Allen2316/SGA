# Generated by Django 4.1.3 on 2023-01-18 21:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estTotal', models.IntegerField()),
                ('doceTotal', models.IntegerField()),
                ('dirTotal', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('directivo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ev_directivo', to='evaluacion.docenteasignaturadocente')),
                ('docente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ev_docente', to='evaluacion.directivoasignaturadocente')),
